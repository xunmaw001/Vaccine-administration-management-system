<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="站点编号" prop="zhandianbianhao">
            <el-input v-model="ruleForm.zhandianbianhao" 
                placeholder="站点编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhandianbianhao" label="站点编号" prop="zhandianbianhao">
              <el-input v-model="ruleForm.zhandianbianhao" 
                placeholder="站点编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="站点名称" prop="zhandianmingcheng">
          <el-input v-model="ruleForm.zhandianmingcheng" 
              placeholder="站点名称" clearable  :readonly="ro.zhandianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="站点地址" prop="zhandiandizhi">
          <el-input v-model="ruleForm.zhandiandizhi" 
              placeholder="站点地址" clearable  :readonly="ro.zhandiandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="站点地址" prop="zhandiandizhi">
              <el-input v-model="ruleForm.zhandiandizhi" 
                placeholder="站点地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zhandianfengmian" label="站点封面" prop="zhandianfengmian">
          <file-upload
          tip="点击上传站点封面"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhandianfengmian?ruleForm.zhandianfengmian:''"
          @change="zhandianfengmianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zhandianfengmian" label="站点封面" prop="zhandianfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhandianfengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="站点详情" prop="zhandianxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhandianxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhandianxiangqing" label="站点详情" prop="zhandianxiangqing">
                    <span v-html="ruleForm.zhandianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	zhandianbianhao : false,
	zhandianmingcheng : false,
	zhandiandizhi : false,
	zhandianxiangqing : false,
	fuzeren : false,
	lianxidianhua : false,
	zhandianfengmian : false,
	clicktime : false,
	clicknum : false,
      },
      ruleForm: {
        zhandianbianhao: this.getUUID(),
        zhandianmingcheng: '',
        zhandiandizhi: '',
        zhandianxiangqing: '',
        fuzeren: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhandianbianhao'){
            this.ruleForm.zhandianbianhao = obj[o];
	    this.ro.zhandianbianhao = true;
            continue;
          }
	    ...
	    this.ro.zhandiandizhi = true;
          ...
          if(o=='zhandianxiangqing'){
            this.ruleForm.zhandianxiangqing = obj[o];
	    this.ro.zhandianxiangqing = true;
            continue;
          }
          if(o=='fuzeren'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='zhandianfengmian'){
            this.ruleForm.zhandianfengmian = obj[o];
	    this.ro.zhandianfengmian = true;
            continue;
          }
          if(o=='clicktime'){
	...
	this.ruleForm.zhandianxiangqing = this.ruleForm.zhandianxiangqing.replace(reg,'../../../springboote6lhv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.zhandianfengmian!=null) {
		this.ruleForm.zhandianfengmian = this.ruleForm.zhandianfengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiezhongdian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiezhongdianCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    zhandianfengmianUploadChange(fileUrls) {
	this.ruleForm.zhandianfengmian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
