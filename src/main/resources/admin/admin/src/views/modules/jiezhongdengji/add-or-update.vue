<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="接种单号" prop="jiezhongdanhao">
            <el-input v-model="ruleForm.jiezhongdanhao" 
                placeholder="接种单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiezhongdanhao" label="接种单号" prop="jiezhongdanhao">
              <el-input v-model="ruleForm.jiezhongdanhao" 
                placeholder="接种单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="接种时间" prop="jiezhongshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jiezhongshijian" 
                type="datetime"
                :readonly="ro.jiezhongshijian"
                placeholder="接种时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiezhongshijian" label="接种时间" prop="jiezhongshijian">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="下次接种" prop="xiacijiezhong">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xiacijiezhong" 
                type="datetime"
                :readonly="ro.xiacijiezhong"
                placeholder="下次接种">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiacijiezhong" label="下次接种" prop="xiacijiezhong">
              <el-input v-model="ruleForm.xiacijiezhong" 
                placeholder="下次接种" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.jiezhongshijian = this.getCurDateTime()

	this.ruleForm.xiacijiezhong = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiezhongdanhao'){
            this.ruleForm.jiezhongdanhao = obj[o];
	    this.ro.jiezhongdanhao = true;
            continue;
          }
	    ...
	    this.ro.jiezhongshijian = true;
          ...
          if(o=='xiacijiezhong'){
            this.ruleForm.xiacijiezhong = obj[o];
	    this.ro.xiacijiezhong = true;
            continue;
          }
          if(o=='beizhu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiezhongdengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiezhongdengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
